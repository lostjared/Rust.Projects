...
fn main() -> Result<(), String> {
    ...
    let tex = mx.printtext_texture(&font, &tc, sdl2::pixels::Color::RGB(255, 0, 0), "Generated at start up")?;
    ...
    'main: loop {
        ...
        mx.can.copy(&tex, None, sdl2::rect::Rect::new(100, 100, tex_w.0, tex_w.1))?;
        mx.can.present();
        frame_counter += 1;
    }
    Ok(())
